  ...
  //Checks to see if we're on the rules page
    if ($('#admin_smart-rules').length) { 
      ...
      //Creates groups based on column names
        const hide_by_default = ['Days mode', 'Decreased loan period for high holds (day)', 'When to charge', 'Suspension in days (day)', 'Max. suspension duration (day)', 'Suspension charging interval', 'No renewal before', 'No automatic renewal before', 'Automatic renewal', 'No automatic renewal after', 'No automatic renewal after (hard limit)', 'Rental discount (%)'];
        const circulation_only = ['Fine amount', 'Fine charging interval', 'When to charge', 'Fine/suspension grace period', 'Overdue fines cap (amount)', 'Cap fine at replacement price', 'Suspension in days (day)', 'Max. suspension duration (day)', 'Suspension charging interval', 'Holds allowed (total)', 'Holds allowed (daily)', 'Holds per record (count)', 'On shelf holds allowed', 'OPAC item level holds', 'Holds pickup period (day)', 'Rental discount (%)']
        const fees_only = ['Current checkouts allowed', 'Current on-site checkouts allowed', 'Loan period', 'Days mode', 'Hard due date', 'Decreased loan period for high holds (day)', 'Suspension in days (day)', 'Max. suspension duration (day)', 'Suspension charging interval', 'Renewals allowed (count)', 'Renewal period', 'No renewal before', 'No automatic renewal before', 'Automatic renewal', 'No automatic renewal after', 'No automatic renewal after (hard limit)', 'Holds allowed (total)', 'Holds allowed (daily)', 'Holds per record (count)', 'On shelf holds allowed', 'OPAC item level holds', 'Holds pickup period (day)']
        const requests_only = ['Current checkouts allowed', 'Current on-site checkouts allowed', 'Loan period', 'Days mode', 'Unit', 'Hard due date', 'Decreased loan period for high holds (day)', 'Fine amount', 'Fine charging interval', 'When to charge', 'Fine/suspension grace period', 'Overdue fines cap (amount)', 'Cap fine at replacement price', 'Suspension in days (day)', 'Max. suspension duration (day)', 'Suspension charging interval', 'Renewals allowed (count)', 'Renewal period', 'No renewal before', 'No automatic renewal before', 'Automatic renewal', 'No automatic renewal after', 'No automatic renewal after (hard limit)', 'Rental discount (%)']
        const suspensions_only = ['Current checkouts allowed', 'Current on-site checkouts allowed', 'Loan period', 'Days mode', 'Unit', 'Hard due date', 'Decreased loan period for high holds (day)', 'Fine amount', 'Fine charging interval', 'When to charge', 'Fine/suspension grace period', 'Overdue fines cap (amount)', 'Cap fine at replacement price', 'Renewals allowed (count)', 'Renewal period', 'No renewal before', 'No automatic renewal before', 'Automatic renewal', 'No automatic renewal after', 'No automatic renewal after (hard limit)', 'Holds allowed (total)', 'Holds allowed (daily)', 'Holds per record (count)', 'On shelf holds allowed', 'OPAC item level holds', 'Holds pickup period (day)', 'Rental discount (%)']
        let column_index = 1;
